...
with sqlite3.connect('Prem1.db') as db:
    c = db.cursor()
try:
    c.execute('CREATE TABLE IF NOT EXISTS user (username TEXT NOT NULL ,password TEXT NOT NULL,mobile TEX NOT NULL);')
except:
    pass
db.commit()
db.close()
...
class main:
    ...
    def widgets(self):
        ...
        Button(self.crff, text='Track', background='lightgrey', bd=2, font=('', 13), padx=6, pady=6,
        ...
        Button(self.consi, text='Back', background='lightgrey', bd=2, font=('', 13), padx=6, pady=6,
